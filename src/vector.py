...
`wsl.exe`. The slim GeoJSONL of named street lines is the input; iD renders the
`name` property as a label and shows all tags on click.
"""
...
WSL_PBF_DIR = "/tmp/toronto-streets-vector-tiles"
...
def build_vector(slim_path=None):
    ...
    tippecanoe = (
        ...
        f"-l {config.VECTOR_LAYER_NAME} -n 'Toronto Street Names' "
